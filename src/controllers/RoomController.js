...
module.exports = {
    async create(req, res) {
        ...
        while (isRoom) {
            ...
            //Verifica se o ID criado já existe
            ...
            //Caso o código já existe, essa parte é pulada e ele irá rodar o while novamente
            if (!isRoom) {
                //Insere a sala criada ao bando
                await db.run(`
    ...
    async enter(req, res) {
        ...
        if (verifyRoom != undefined) {
            res.redirect(`/room/${roomId}`)
        } else {
            res.render('roomNotExist')
        }
